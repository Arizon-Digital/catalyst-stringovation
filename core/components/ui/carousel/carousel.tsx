  ...
  return (
    ...
    >
      <div className="flex items-center justify-between">
        <h2 className="text-3xl font-black lg:text-4xl px-4" id={titleId}>
          {title}
        </h2>
        <span className="no-wrap flex">
          <button
            ...
            className={cn(
              'inline-flex h-12 w-12 hover:text-[#e0af06] items-center justify-center focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-primary/20 disabled:text-gray-400',
